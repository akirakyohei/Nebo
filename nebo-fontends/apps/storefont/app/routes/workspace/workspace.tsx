...
import { Outlet, matchPath, useLocation } from "@remix-run/react";

import React from "react";
import { Navbar, NavigateItemProp, NavigateSectionProp } from "../../components/Navbar";
...
const navigateItems: NavigateSectionProp[] = [
  {
    items: [
      ...
      { icon: <TaskAltOutlined />, label: "Mẫu", url: "/workspace/templates" },
    ],
  },
  {
    label: "Công cụ",
    items: [
      {
        ...
        url: "/workspace/auto_informations",
      },
    ],
  },
  {
