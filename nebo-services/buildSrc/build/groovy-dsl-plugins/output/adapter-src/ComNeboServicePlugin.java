...
/**
 * Precompiled com.nebo.service script plugin.
 **/
public class ComNeboServicePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComNeboService").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.nebo.base");
            target.getPluginManager().apply("org.springframework.boot");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComNeboService").asSubclass(BasicScript.class);
