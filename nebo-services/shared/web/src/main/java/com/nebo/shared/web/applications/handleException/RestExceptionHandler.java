...
import com.nebo.shared.web.applications.model.Error;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(com.nebo.shared.web.applications.exception.ConstraintViolationException.class)
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    @ResponseBody
    public ResponseEntity<Error> handleCustomConstraintViolationException(com.nebo.shared.web.applications.exception.ConstraintViolationException exception) {
