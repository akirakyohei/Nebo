...
public class SizeUtils {
    ...
    public static float convertSizeTomm(float size, String unitOfSize) {
        switch (unitOfSize) {
            case "cm":
                return size * 10;
            case "in":
    ...
    public static float convertSizeToPt(float size, String unitOfSize) {
        switch (unitOfSize) {
            case "cm":
                return size * 37.7952f;
            case "mm":
                return size * 3.77952f;
            case "in":
                return size * 72f;
            case "px":
                return size * 72 / 96;
